...
import { ElRow, ElProgress, ElCard, ElSpace } from 'element-plus'
...
<template>
  <ElCard class="mb-20px">
    <ElSpace style="width: 100%" wrap spacer="|" :size="1">
      <el-row>
        <svg
      ...
      <ElRow>
        ...
        <span> 内存占用：</span>
        <el-progress :percentage="60" :text-inside="true" :stroke-width="22" status="warning" />
      </ElRow>
    </ElSpace>
  </ElCard>
</template>
